      ...
      <main className="flex-grow pb-16 pt-[120px] md:pb-20 md:pt-[150px]">
        <div className="main-container">
          {isLoading ? (
            ...
            <div className="flex w-full min-w-0 flex-col gap-10 lg:grid lg:grid-cols-12 lg:items-start lg:gap-12">
              {/* Left: profile card */}
              <RevealAnimation delay={0.1}>
                <aside className="w-full min-w-0 lg:sticky lg:top-[130px] lg:col-span-4">
                  <section className="flex flex-col items-center gap-6 rounded-[30px] border border-white/5 bg-[#0A0A0A] p-6 text-center sm:p-8 lg:items-start lg:text-left">
...
const ProfileSkeleton = () => (
  <div className="flex w-full flex-col gap-10 lg:grid lg:grid-cols-12 lg:items-start lg:gap-12">
    <div className="flex flex-col items-center gap-6 rounded-[30px] border border-white/5 bg-[#0A0A0A] p-6 sm:p-8 lg:col-span-4 lg:items-start">
