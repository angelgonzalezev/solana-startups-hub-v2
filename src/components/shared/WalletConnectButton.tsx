        ...
        createPortal(
          <div
            ...
            <div
              ...
              className="my-auto max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-[30px] border border-white/5 bg-[#0A0A0A] p-5 shadow-2xl shadow-primary-500/10 sm:max-h-[calc(100dvh-3rem)] sm:p-7">
