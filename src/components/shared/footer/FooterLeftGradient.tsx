...
const FooterLeftGradient = ({ className }: FooterLeftGradientProps) => {
  return (
    <RevealAnimation delay={0.4} duration={0.8} direction="left" offset={400}>
      <figure
        className={cn(
          'pointer-events-none absolute bottom-[-33%] left-[-83%] hidden size-[728px] select-none md:block min-[2559px]:!left-[-16%] md:bottom-[-60%] md:left-[-52%] md:size-[870px] lg:left-[-38%] xl:bottom-[-77%] xl:left-[-30%] 2xl:left-[-22%]',
          className,
        )}>
