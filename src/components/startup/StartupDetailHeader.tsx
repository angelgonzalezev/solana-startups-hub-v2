    ...
    <div className="space-y-8 md:space-y-10">
      <div className="flex flex-col justify-between gap-7 lg:flex-row lg:items-center lg:gap-8">
        ...
        <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:items-start sm:gap-7 sm:text-left">
          <div className="relative size-24 flex-shrink-0 overflow-hidden rounded-lg border border-white/10 bg-[#0A0A0A] shadow-2xl shadow-primary-500/10 sm:size-28 lg:size-32">
            {logoUrl ? (
      ...
      <div className="grid grid-cols-2 gap-3 border-y border-white/10 py-5 sm:flex sm:flex-wrap sm:items-center sm:justify-start sm:py-6">
        {startup.website && (
          <a
            ...
            className="group flex items-center justify-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-3 transition-all hover:bg-white/10 sm:px-5">
            <svg
