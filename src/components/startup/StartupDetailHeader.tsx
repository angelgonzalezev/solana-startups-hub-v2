        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 text-center sm:text-left">
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4">
              <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight">{startup.name}</h1>
              <StartupStageBadge stage={startup.stage} />
            </div>
            <p className="text-xl md:text-2xl text-white/70 max-w-[700px] leading-relaxed">{startup.oneLiner}</p>
