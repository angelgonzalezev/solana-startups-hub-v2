  ...
  return (
    <div className="space-y-7 rounded-lg border border-white/10 bg-[#0A0A0A] p-5 sm:p-6 md:p-8">
      ...
      <div className="flex flex-col items-center gap-5 border-b border-white/10 pb-7 sm:flex-row sm:items-start">
        <div className="relative size-20 flex-shrink-0 overflow-hidden rounded-md border border-white/10 bg-black">
          {avatarUrl ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {founder.twitterHandle && (
              <a
                ...
                className="group flex min-w-0 flex-col items-start gap-2 rounded-md border border-white/10 bg-black p-4 transition-all hover:border-primary-500/50 hover:bg-primary-500/5">
